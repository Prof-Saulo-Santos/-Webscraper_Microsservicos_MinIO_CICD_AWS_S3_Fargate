...
![Arquitetura AWS Fase 4](https://mermaid.)
...
Como é um projeto acadêmico, otimizamos onde é possível, mantendo a estabilidade onde é crítico:

1.  **Ingestion (Batch/Agendado):**
    *   Usa **Fargate Spot** (definido no `eventbridge.tf`).
    *   Roda, processa e desliga. Custo extremamente baixo (~70% desconto).

2.  **Processing (Manual/Sob Demanda):**
    *   Executado manualmente via "Run Task".
    *   Pode usar Spot ou On-Demand, dependendo da escolha na hora do *Run*.

3.  **Frontend (Always-on / On-Demand):**
    *   Este serviço precisa de alta disponibilidade e não pode ser interrompido abruptamente.
    *   Utiliza **AWS Fargate On-Demand** (Padrão) para garantir que a apresentação não falhe.
    *   **Controle de Custo:** Alteramos o `Desired Tasks` para 0 quando não está em uso.
